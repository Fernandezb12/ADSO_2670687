...
let venta3 = prompt("Ingrese el monto de la tercera venta");
let porcen = 30/100;
let comision = parseInt(venta1)+ parseInt(venta2)+ parseInt(venta3);
let resul = parseInt(sueldo) + parseInt(comision*porcen);
let resulf = parseInt(resul); 

alert("El salario total en el mes es: $" +resulf+ " COP");*/
